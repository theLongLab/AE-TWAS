...
out_pheno_df_res.to_csv("/work/long_lab/qli/AE-TWAS/GTEX_AE/revision202408/gene_expression_X_h_X_apo/AE_shallow/"+M+"_Div8_ID670_R"+str(R_2)+"_output_gcta.txt",sep=" ",header=None,index=True)
out_pheno_df_res.to_csv("/work/long_lab/qli/AE-TWAS/GTEX_AE/revision202408/gene_expression_X_h_X_apo/AE_shallow/"+M+"_Div8_ID670_R"+str(R_2)+"_output_head_gcta.txt",sep=" ",header=True,index=True)

coder2_df_res.to_csv("/work/long_lab/qli/AE-TWAS/GTEX_AE/revision202408/gene_expression_X_h_X_apo/AE_shallow/"+M+"_Div8_ID670_R"+str(R_2)+"_code_gcta.txt",sep=" ",header=None,index=True)
coder2_df_res.to_csv("/work/long_lab/qli/AE-TWAS/GTEX_AE/revision202408/gene_expression_X_h_X_apo/AE_shallow/"+M+"_Div8_ID670_R"+str(R_2)+"_code_head_gcta.txt",sep=" ",header=True,index=True)

pheno_df_all.index=pheno_df_all.iloc[:,0]
pheno_df_all.to_csv("/work/long_lab/qli/AE-TWAS/GTEX_AE/revision202408/gene_expression_X_h_X_apo/AE_shallow/"+M+"_Div8_ID670_R"+str(R_2)+"_input_gcta.txt",sep=" ",header=None,index=True)
pheno_df_all.to_csv("/work/long_lab/qli/AE-TWAS/GTEX_AE/revision202408/gene_expression_X_h_X_apo/AE_shallow/"+M+"_Div8_ID670_R"+str(R_2)+"_input_head_gcta.txt",sep=" ",header=True,index=True)
